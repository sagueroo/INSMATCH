...
const Register = ({ onGoToLogin }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      alert("Inscription réussie ! Bienvenue " + response.data.first_name);
  ...
  return (
    <div style={{
      ...
      <div className="reg-card" style={{
        width: '100%', maxWidth: '460px', background: '#0f2040',
          ...
          {[1, 2].map(s => (
            <div key={s} style={{ flex: 1, display: 'flex', flexDirection: 'column', gap: '4px' }}>
              <div style={{
                ...
                background: s <= step ? '#E30613' : '#1a3358',
          ...
          {step === 1 ? (
            <div className="step-content" key="step1">
              <div className="name-row">
                <InputField label="Prénom" placeholder="Mejdi" value={formData.first_name} onChange={set('first_name')}
                ...
                />
                <InputField label="Nom" placeholder="Belhaj" value={formData.last_name} onChange={set('last_name')}
                  icon={<svg width="18" height="18" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24"><path d="M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2"/><circle cx="12" cy="7" r="4"/></svg>}
                />
              </div>
            ...
            <div className="step-content" key="step2">
              ...
              <div style={{
                ...
                background: '#162a4a', border: '1px solid #1e3a5f', borderRadius: '14px',
                ...
                <div style={{
                  ...
                  border: `2px solid ${isProfessor ? '#E30613' : '#1e3a5f'}`,
          ...
          <div style={{ display: 'flex', gap: '10px', marginTop: '8px' }}>
            {step === 2 && (
              <button type="button" onClick={() => setStep(1)} style={{
                ...
                border: '1.5px solid #1e3a5f', borderRadius: '14px', color: '#e2e8f0',
